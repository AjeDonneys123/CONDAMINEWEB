...
export class DataManager {
  ...
  public restorePlayerHealth(): void {
    ...
    const dataToPass: PlayerHealthUpdated = {
      ...
      type: PLAYER_HEALTH_UPDATE_TYPE.INCREASE,
    };
    // Cet événement est volontairement émis même si les données pensaient déjà
    // le joueur au maximum : il resynchronise aussi le HUD après un changement de salle.
    EVENT_BUS.emit(CUSTOM_EVENTS.PLAYER_HEALTH_UPDATED, dataToPass);
  }

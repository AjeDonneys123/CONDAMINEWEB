...
export class PreloadScene extends Phaser.Scene {
  ...
  public preload(): void {
    ...
    this.load.image('condamine-grenade-launcher', 'assets/condamine/heavy-grenade-launcher.png');
    this.load.image('condamine-grenade', 'assets/condamine/grenade-projectile.png');
    this.load.image('condamine-grenade-explosion', 'assets/condamine/grenade-explosion.png');
  }

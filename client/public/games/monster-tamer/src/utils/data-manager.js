...
class DataManager extends Phaser.Events.EventEmitter {
  ...
  saveData() {
    ...
    try {
      ...
      // Condamine peut déjà occuper la totalité du quota du navigateur. Une
      // sauvegarde locale du mini-jeu ne doit jamais empêcher la partie de
      // démarrer ou faire planter une transition entre deux scènes.
      console.warn(`[${DataManager.name}:saveData] sauvegarde locale ignorée (stockage indisponible).`, error);
    }
  }

                ...
                <div className="learning-step">
                    {module.presentationUrl && (
                        <button
                            ...
                            className="mr-3 px-3 py-1 rounded-xl bg-slate-900 hover:bg-slate-800 text-white text-xs font-black shadow-sm transition inline-flex items-center gap-1.5 cursor-pointer"
                        >
                            <span>👁</span>
                            <span>Slides du cours</span>
                        </button>
                    )}

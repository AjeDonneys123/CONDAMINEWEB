    ...
    if (submittedResult) {
        return (
            <div className="conda-redaction-container flex items-center justify-center p-6 text-center">
                <div className="bg-slate-900 border border-slate-700 rounded-3xl p-10 max-w-xl w-full shadow-2xl space-y-6">
                    <div className="text-5xl">📄</div>
                    <h2 className="text-2xl font-black text-white uppercase tracking-wider">Devoir Rédaction Transmis !</h2>
                    <p className="text-sm text-slate-300 leading-relaxed">
                        Votre rédaction, votre brouillon et votre historique d'échange avec l'IA ont bien été enregistrés et transmis à votre professeur pour correction.
                    </p>
                    ...
                    {submittedResult.feedback_fond && (
                        <div className="bg-slate-800/80 p-4 rounded-2xl border border-slate-700 text-left text-xs text-slate-300 leading-relaxed whitespace-pre-wrap max-h-48 overflow-y-auto">
                            {submittedResult.feedback_fond}
                        </div>
                    )}
                    <div>

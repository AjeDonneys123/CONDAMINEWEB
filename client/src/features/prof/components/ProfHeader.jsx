  ...
  return (
    <div className="p-8 pb-4 flex justify-between items-center bg-white relative">
      ...
      <div className="flex gap-3">
          <button onClick={() => setShowDB(true)} className="bg-slate-900 text-white px-4 py-2 rounded-2xl font-black text-[10px] uppercase shadow-lg hover:bg-slate-800 transition-all">📊 Database</button>

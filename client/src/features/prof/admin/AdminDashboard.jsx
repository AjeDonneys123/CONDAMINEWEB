...
export default function AdminDashboard({ user, onRefresh }) {
    ...
    const handleOpenCreate = () => {
        let defaults = { firstName: '', lastName: '', email: '', parentEmail: '', classId: '', currentLevel: '', assignedGroups: [], name: '', level: '', type: 'CLASS' };

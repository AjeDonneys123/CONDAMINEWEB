...
const Models = {
    ...
    ClassroomScan: getModel('ClassroomScan', {
        ...
        correctionPromptImageDriveId: { type: String, default: '' },
    ...
    GptInboxMessage: getModel('GptInboxMessage', {
        ...
        devoirComplet: { type: String, default: '' },
        openaiFileIdRefs: { type: [String], default: [] },
        evaluationType: { type: String, enum: ['dnb_developpement_construit', 'rqp_seconde', 'DNB', 'RQP_SECONDE'], default: 'DNB', index: true },
        note: { type: Number, min: 0, max: 20, default: null },
        forme: { type: Number, min: 0, max: 2, default: null },
        introduction: { type: Number, min: 0, max: 5, default: null },
        arguments: { type: Number, min: 0, max: 2, default: null },
        exemples: { type: Number, min: 0, max: 2, default: null },
        developpement: { type: Number, min: 0, max: 10, default: null },
        conclusion: { type: Number, min: 0, max: 2, default: null },
        expression: { type: Number, min: 0, max: 3, default: null },

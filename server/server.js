...
// IMPORTANT : Doit être fait AVANT de charger les routes
require('./models/Bug');
...
// 3. ROUTES SYSTÈME (FIX ERROR 500)
...
app.get('/api/deploy-status', async (req, res) => {
    try {
        ...
        // Chemin corrigé : server.js et version.json sont dans le même dossier /server
...
app.listen(port, () => {
    ...
    console.log(`📡 BASE : ${mongoose.connection.name || 'En attente...'}`);
    console.log(`-----------------------------------------------`);
});
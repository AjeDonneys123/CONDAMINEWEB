...
mongoose.connect(process.env.MONGODB_URI).then(() => console.log('✅ Connected Build 335'));
...
app.get('/api/deploy-status', (req, res) => res.json({ version: "2.3.5", build: 335, status: "live" }));

...
mongoose.connect(process.env.MONGODB_URI).then(() => console.log('✅ MongoDB Connected (Build 321)'));
...
app.get('/api/deploy-status', (req, res) => res.json({ version: "2.2.1", build: 321, status: "live" }));

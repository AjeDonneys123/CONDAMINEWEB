...
mongoose.connect(process.env.MONGODB_URI).then(() => console.log('✅ MongoDB Connected (Build 322)'));
...
app.get('/api/deploy-status', (req, res) => res.json({ version: "2.2.2", build: 322, status: "live" }));

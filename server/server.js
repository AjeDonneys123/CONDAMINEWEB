...
// 1. DÉFINITION / CHARGEMENT DES MODÈLES (CRITIQUE)
...
// 3. API SYSTÈME ULTRA-ROBUSTE (NE DOIT JAMAIS RENVOYER 500)
app.get('/api/system-status', (req, res) => {
    try {
        ...
        // En cas d'erreur de lecture/parse, on renvoie OK pour ne pas bloquer le front
        res.json({ status: 'OK', warning: "Status file temporary unreadable" });
    }
});

// @signatures: SERVER_BOOT_ID, GlobalInfrastructure, KernelV67_AUDIO_DEBUG
...
console.log("------------------------------------------------");
console.log("🚀 KERNEL V67 : AUDIO PROXY RAW");
console.log("------------------------------------------------");
...
// PROXY AUDIO/IMAGE ULTRA-TRANSPARENT
...
app.get(['/api/proxy/:id', '/api/structure/proxy/:id'], async (req, res) => {
    try {
        ...
        // On ne définit AUCUN Content-Type pour laisser le décodage binaire se faire proprement

...
SÉCURITÉ AUTH: Les passwords des professeurs sont hashés avec bcryptjs. Ne jamais supposer un stockage en clair. Vérifier avec bcrypt.compare et hasher avec bcrypt.hash.
